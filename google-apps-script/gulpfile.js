...
// gulp.task('upload-latest', ['copy-latest']);
...
function generateTemplate() {
    return gulp.src(srcRoot + '/**/templates/*.html')
        .pipe(rename({ dirname: '' }))
        .pipe(templateCache("templates.js.html", { standalone: true }))
...
function copyComponentsCode() {
    return gulp.src([
        srcRoot + '/components/**/*.js',
        '!' + srcRoot + '/components/**/server/**/*.js',
        '!' + srcRoot + '/components/**/templates/**/*.js'])
        .pipe(rename({ dirname: '' }))
        .pipe(gulp.dest(bldFolder + '/components'))
        .pipe(concat('components.js.html', { newLine: '\r\n' }))
        .pipe(gulp.dest(dstRoot));;
